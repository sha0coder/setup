...
editor = "novim" --os.getenv("EDITOR") or "editor"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "t", function () awful.spawn("/home/sha0/soft/Telegram/telegram.sh") end, 
