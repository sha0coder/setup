...
apt install -y git curl pkg-config tmux wget fish dnsutils
apt install -y python3
apt install -y python3-pip
apt install -y zlib1g zlib1g-dev 
apt install -y unzip nodejs npm ffmpeg ranger mplayer strace ltrace valgrind
npm install -g npm 
apt install -y net-tools ufw readline-common wireshark tshark tcpdump tcpflow nautilus nitrogen
